...
TOKEN = "8037958434:AAHlSHurC-9HCD9_OOxifRmFZPRtQITA3XM"
OWNER_IDS = [5951659304]
...
EQUIPMENTS = {
    "atomic_bomb": {"name": "💣 بمب اتم", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 100},
    "iron_dome": {"name": "🛡️ گنبد آهنین", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 200},
    "hypersonic": {"name": "🚀 هایپر سونیک", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 80},
    "nuclear_bomb": {"name": "☢️ بمب هستی", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 500},
    "air_defense": {"name": "🛡️ پدافند هوایی", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 150},
    "ballistic_missile": {"name": "🚀 موشک بالستیک", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 50},
    "drone": {"name": "✈️ پهپاد", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 20},
    "bomber": {"name": "✈️ بمب افکن", ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": 450},
}
...
ADMIN_PERMISSIONS = {
    ...
    "end_game": "پایان بازی",
    "broadcast": "همگانی",
    "set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": "تعیین قیمت کشورها",
    "ban_user": "بن کاربر",
    ...
    "set_equipment_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": "تغییر قیمت تجهیزات",
...
class Database:
    ...
    def create_tables(self):
        ...
        CREATE TABLE IF NOT EXISTS countries (
            ...
            status TEXT,
            "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" INTEGER,
            owner_id INTEGER,
    ...
    def initialize_countries(self):
        ...
        for country, status in COUNTRIES.items():
            cursor.execute('''
            INSERT OR IGNORE INTO countries (name, status, "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price")
            VALUES (?, ?, ?)
            ''', (country, status, 100))
        self.conn.commit()

    def set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"(self, country_name, "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"):
        cursor = self.conn.cursor()
        cursor.execute('UPDATE countries SET "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" = ? WHERE name = ?', ("message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price", country_name))
        self.conn.commit()

    def get_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"(self, country_name):
        cursor = self.conn.cursor()
        cursor.execute('SELECT "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" FROM countries WHERE name = ?', (country_name,))
        result = cursor.fetchone()
        return result[0] if result else None
...
async def panel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_owner or "set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"" in admin_permissions:
        temp_row.append(InlineKeyboardButton("💰 قیمت کشورها", callback_data="set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price""))
    ...
    if is_owner or "set_equipment_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"" in admin_permissions:
        temp_row.append(InlineKeyboardButton("⚔️ قیمت تجهیزات", callback_data="set_equipment_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price""))
...
"""
        ...
        "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" = db.get_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"(country)
        if not "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price":
            await query.edit_message_text("⛔ قیمت این کشور تعیین نشده است!")
            return

        context.user_data["selected_country"] = country
        await query.edit_message_text(
            f"🏰 کشور انتخابی: {country}\n💰 قیمت: {"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"} داگز\n\n"
...
"""
    ...
    elif data == "set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"":
        if user_id not in OWNER_IDS and "set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"" not in db.get_admin_permissions(user_id):
            return

        available_countries = db.get_available_countries()
        keyboard = [
            [InlineKeyboardButton(country, callback_data=f"set"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_{country}")]
            for country in available_countries
        ]
    ...
    elif data.startswith("set"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_"):
        country = data.replace("set"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_", "")
        context.user_data["setting_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for"] = country
        await query.edit_message_text(f"💰 قیمت {country} را به عدد وارد کنید:")

    elif data == "set_equipment_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"":
        if user_id not in OWNER_IDS and "set_equipment_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"" not in db.get_admin_permissions(user_id):
            return

        keyboard = [
            [InlineKeyboardButton(eq["name"], callback_data=f"set_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_{eq_id}")]
            for eq_id, eq in EQUIPMENTS.items()
        ]
        keyboard.append([InlineKeyboardButton("🔙 بازگشت", callback_data="panel")])
        reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    elif data.startswith("set_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_"):
        equipment_id = data.replace("set_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_", "")
        context.user_data["setting_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for"] = equipment_id
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if "setting_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for" in context.user_data:
            country = context.user_data["setting_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for"]
            try:
                "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" = int(message_text)
                if "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" <= 0:
                    await update.message.reply_text("⛔ قیمت باید بیشتر از صفر باشد!")
                    return
                    
                db.set_country_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"(country, "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price")
                await update.message.reply_text(f"✅ قیمت {country} به {"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"} داگز تنظیم شد.")
                context.user_data.pop("setting_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for", None)
            except ValueError:
                await update.message.reply_text("⛔ لطفاً یک عدد معتبر وارد کنید!")
            return

        elif "setting_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for" in context.user_data:
            equipment_id = context.user_data["setting_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for"]
            try:
                "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" = int(message_text)
                if "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" <= 0:
                ...
                EQUIPMENTS[equipment_id][""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price""] = "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"
                await update.message.reply_text(f"✅ قیمت {EQUIPMENTS[equipment_id]['name']} به {"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"} داگز تنظیم شد.")
                context.user_data.pop("setting_eq_"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"_for", None)
            except ValueError:
                await update.message.reply_text("⛔ لطفاً یک عدد معتبر وارد کنید!")
            return
            ...
            try:
                ...
                await update.message.reply_text(
                    f"💰 مبلغ قابل پرداخت: {equipment['"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"'] * quantity} داگز\n\n"
                    f"لطفاً پیام پرداخت خود را ارسال کنید (متن دلخواه). درخواست شما به ادمین ارسال خواهد شد."
                )
            ...
            if not country or not "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price":
            ...
            payment_requests[request_id] = {
                ...
                "username": username,
                "country": country,
                ""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"": "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price",
            ...
            for owner_id in OWNER_IDS:
                try:
                    await context.bot.send_message(
                        ...
                        f"کشور: {country}\n"
                        f"قیمت: {"message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price"} داگز\n"
                        f"کاربر: @{username}\n\n"
                        f"پیام پرداخت:\n{message_text}",
                        reply_markup=InlineKeyboardMarkup([
            ...
            "message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price" = equipment[""message": "برای خرید این آیتم به پیوی ادمین پیام بده: @mehrab_matinfar", "price""] * quantity
